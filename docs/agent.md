...
> Firebase App Hosting (SSR · Cloud Run · asia-east1), web.app은 Firebase Hosting 프록시 환경의 제약. 상세는 RELIABILITY.md.
...
- 환경변수 접근: process.env (서버 라우트) · apphosting.yaml env + Secret Manager (`process.env` 직접 사용 금지인 경우)
